...
function App() {
    ...
    // League definitions with current active rounds (approximate for demo)
    const leagues = [
        { id: '4339', name: 'Süper Lig', round: '14' },
        { id: '4328', name: 'Premier League', round: '14' },
        { id: '4335', name: 'La Liga', round: '16' },
        { id: '4331', name: 'Bundesliga', round: '12' },
        { id: '4332', name: 'Serie A', round: '14' }
    ]
    ...
    const handleLeagueSelect = async (leagueId) => {
        ...
        try {
            ...
            // We use s=2024-2025 as the current season.
            const response = await axios.get(`https://www.thesportsdb.com/api/v1/json/3/eventsround.php?id=${leagueId}&r=${selectedLeague.round}&s=2024-2025`)
